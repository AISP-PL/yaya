...
class DetectorYOLOv4Gpr(DetectorYOLOv4):
    '''
    classdocs
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        cfgPath = './ObjectDetectors/yolov4gpr/cfg/yolov4.cfg'
        weightPath = './ObjectDetectors/yolov4gpr/cfg/yolov4.weights'
        metaPath = './ObjectDetectors/yolov4gpr/cfg/custom.data'
